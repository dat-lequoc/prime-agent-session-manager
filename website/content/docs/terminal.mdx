...
Prime-Agent Session Manager includes a built-in terminal powered by [xterm.js](https://xtermjs.org/) on the frontend and [portable-pty](https://docs.rs/portable-pty) on the backend.
