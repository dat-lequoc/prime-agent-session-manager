...
Prime-Agent Session Manager supports exporting sessions in three formats, making it easy to share, archive, or process your AI conversations.
...
You can also export sessions programmatically via the [API](./api):
