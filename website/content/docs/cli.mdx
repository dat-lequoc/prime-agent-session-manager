---
title: CLI Mode
description: Run Prime Agent Session Manager as a headless backend service for servers and remote access.
---

import { Callout } from 'fumadocs-ui/components/callout';

The CLI mode runs Prime Agent Session Manager as a headless backend service — no GUI window, just the API server with the embedded frontend. Ideal for servers, remote access, and Docker deployments.
