---
title: CLI 模式
description: 将 Prime Agent Session Manager 作为无头后端服务运行，适用于服务器和远程访问。
---

import { Callout } from 'fumadocs-ui/components/callout';

CLI 模式将 Prime Agent Session Manager 作为无头后端服务运行——没有 GUI 窗口，仅提供带嵌入式前端的 API 服务器。适用于服务器、远程访问和 Docker 部署。
